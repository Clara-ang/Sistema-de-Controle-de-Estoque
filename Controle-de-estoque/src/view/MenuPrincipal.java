    ...
    public static void iniciar() {
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    switch (op) {
                        ...
                        case 4:
                            ...
                            int idCatEd = Integer.parseInt(sc.nextLine());
                        ...
                        case 6:
                            System.out.print("ID do Fornecedor a editar: ");
                            int idForEd = Integer.parseInt(sc.nextLine());
                            ...
                            System.out.print("Novo nome: ");
                            String novoNomeFor = sc.nextLine();
                        ...
                        case 7:
                            ...
                            int idForRem = Integer.parseInt(sc.nextLine());
                        ...
                        case 13:
                            ...
                            if (produtosBaixoEstoque.isEmpty()) {
                                ...
                                for (Produto produto : produtosBaixoEstoque) {
                                    System.out.println("ALERTA: O produto '" + produto.getNome() + 
                        ...
                        default:
                            System.out.println("Opção inválida. Digite um número entre 0 e 13.");
                    }
                ...
                sc.nextLine(); // Limpar buffer em caso de erro grave
            }
        }
    }
}